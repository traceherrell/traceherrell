      ...
      <div className="card medium-margin">
        <div className="card-content">
          ...
          <ul className="large-margin">
            ...
            <li className="small-padding">
              Customizable configuration templates for different vehicle models
            </li>
            <li className="small-padding">
          ...
          <div className="row medium-margin">
            ...
            <span className="chip secondary">JFrog</span>
            <span className="chip secondary">Yugabyte</span>
            <span className="chip secondary">
              Kubevela - Open Application Model
            </span>
            <span className="chip secondary">GCP Kubernetes</span>
            <span className="chip secondary">Go</span>
            <span className="chip secondary">Github Actions</span>
          </div>
        </div>
      </div>
      <div className="medium-margin">
      ...
      <div className="card medium-margin">
        <div className="card-content">
          ...
          <p>
            ...
            architecting both the frontend application and the backend services
            that power the Ford Configuration Platform. I worked closely with
            Ford's engineering team to understand their requirements and ensure
            that the platform met their needs.
          </p>
