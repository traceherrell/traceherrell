      ...
      <div className="card medium-margin">
        <div className="card-content">
          ...
          <div className="row medium-margin">
            ...
            <span className="chip secondary">Ansible Automation Platform</span>
      ...
      <div className="card medium-margin">
        <div className="card-content">
          ...
          <p>
            ...
            cloud-native application infrastructure, designed the real-time data
            processing pipeline. I worked closely with T-Mobile's network
          ...
          <p>
            ...
            problem by creating a custom API that translated network data into a
            format that the Nessie platform could understand.
          </p>
        </div>
      </div>
    </div>
